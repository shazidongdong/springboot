...
public class MyBatisPlusGenerator {
    ...
    public void codeGenerator() {
        ...
        dsc.setUrl("jdbc:mysql://129.204.84.53:3306/springboot?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.hm");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
        ...
        strategy.setTablePrefix("t_");  //表前缀，添加该表示，则生成的实体，不会有表前缀，比如sys_dept 生成就是Dept
